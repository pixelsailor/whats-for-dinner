...
| **AI capability UI** | Combines online + `featureFlags.openai` + session + `aiAssistedRecipe` permission                   | [`src/lib/api/auth/auth.capability.ts`](../src/lib/api/auth/auth.capability.ts) `deriveAICapability` — **no** cloud/Sync capability helper parallel to this                                                                                                                 |
