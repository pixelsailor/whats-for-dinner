...
| **globs** | Loaded when the agent touches files matching the glob pattern. | svelte-5-ui-conventions, local-data-dexie-ownership, ui-conventions, error-handling-conventions, security-sanitization, storage-conventions |
