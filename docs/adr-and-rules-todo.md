...
- [x] **Rule: Supabase enhancement boundary**
  ...
  - **Done:** [`.cursor/rules/supabase-enhancement-boundary.mdc`](../.cursor/rules/supabase-enhancement-boundary.mdc) (globs hooks, root layouts, standalone Supabase client modules, `src/lib/api/cloud/**`, account/auth API layers, `src/app.d.ts`). **Follow-up:** [`docs/readme-adr-alignment-gaps.md`](./readme-adr-alignment-gaps.md) — **GAP-017** (unified Supabase client interface); **GAP-016** resolved 2026-06-05. **Legacy `agents.md` wiring correction:** [Supabase wiring migration notes](./readme-adr-alignment-gaps.md#supabase-wiring-migration-notes-2026-05-12).
...
- [x] **Migrate Supabase auth, sharing, and cloud-backup wiring**
  ...
  - **Done:** [`.cursor/rules/supabase-enhancement-boundary.mdc`](../.cursor/rules/supabase-enhancement-boundary.mdc) now includes _Auth, sharing, and backup — client surfaces_ (accurate map: `locals.supabase`, `+layout.ts` / `data.supabase`, narrow `supabaseClient.ts`). **Surfaced discrepancies:** [Deferred — Supabase wiring migration notes](./readme-adr-alignment-gaps.md#supabase-wiring-migration-notes-2026-05-12) (**GAP-016** resolved 2026-06-05; **GAP-017** open).
