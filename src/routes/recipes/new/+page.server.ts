// import { OPENAI_DISABLED_ERROR, appendRecipeDetails } from '$lib/server/openai';
...
// 			prep_time: data.get('time_prep')?.toString().trim() ?? '',
// 			cook_time: data.get('time_cook')?.toString().trim() ?? '',
// 			total_time: '',
