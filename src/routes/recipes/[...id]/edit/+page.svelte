		...
		>
			...
			<div class="grid gap-6 sm:grid-cols-2">
				<fieldset class="flex flex-col gap-3 rounded-md border border-transparent">
					...
					<div class="flex flex-wrap items-end gap-3">
						<div class="flex min-w-[6rem] flex-1 flex-col gap-1">
							<label class="text-sm text-muted-foreground" for="prep-min">Min</label>
							<input
								id="prep-min"
								class="border-input bg-background w-full rounded-md border px-3 py-2 text-base outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
								type="text"
						...
						<div class="flex min-w-[6rem] flex-1 flex-col gap-1">
							<label class="text-sm text-muted-foreground" for="prep-max">Max (optional)</label>
							<input
								id="prep-max"
								class="border-input bg-background w-full rounded-md border px-3 py-2 text-base outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
								type="text"
				...
				<fieldset class="flex flex-col gap-3 rounded-md border border-transparent">
					...
					<div class="flex flex-wrap items-end gap-3">
						<div class="flex min-w-[6rem] flex-1 flex-col gap-1">
							<label class="text-sm text-muted-foreground" for="cook-min">Min</label>
							<input
								id="cook-min"
								class="border-input bg-background w-full rounded-md border px-3 py-2 text-base outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
								type="text"
						...
						<div class="flex min-w-[6rem] flex-1 flex-col gap-1">
							<label class="text-sm text-muted-foreground" for="cook-max">Max (optional)</label>
							<input
								id="cook-max"
								class="border-input bg-background w-full rounded-md border px-3 py-2 text-base outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
								type="text"
