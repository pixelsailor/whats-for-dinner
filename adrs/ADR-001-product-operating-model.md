...
- **Cursor / agent rules:** [`.cursor/rules/offline-first-development.mdc`](../.cursor/rules/offline-first-development.mdc), [`.cursor/rules/offline-connectivity-capability.mdc`](../.cursor/rules/offline-connectivity-capability.mdc), [`.cursor/rules/supabase-enhancement-boundary.mdc`](../.cursor/rules/supabase-enhancement-boundary.mdc), and [`.cursor/rules/ai-integration-boundary.mdc`](../.cursor/rules/ai-integration-boundary.mdc) implement this ADR; new rules in those areas must cite it. [README.md](../README.md) **Product Principles** remain the human entrypoint.
...
- Verify new features against the matrix: no new **core** capability that requires auth, network, Supabase, or OpenAI unless this ADR is updated or a row is added in [docs/readme-adr-alignment-gaps.md](../docs/readme-adr-alignment-gaps.md).
...
- Record gaps in [docs/readme-adr-alignment-gaps.md](../docs/readme-adr-alignment-gaps.md) when tests cannot yet cover a declared guarantee.

### Alignment gaps

- Track significant mismatches in [docs/readme-adr-alignment-gaps.md](../docs/readme-adr-alignment-gaps.md); use PR descriptions only for gaps fixed in the same change.
