...
| 8 | **Dexie + LiveQueryStores Guidelines** (89–106) | Planned **Rule: Local data and Dexie ownership** + [ADR-002](../adrs/ADR-002-local-data-ownership.md) | Todo: *Migrate Dexie…*; resolve `src/lib/db/` vs `src/lib/db.ts` ([GAP-012](readme-adr-alignment-gaps.md)) |
