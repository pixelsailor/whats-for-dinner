...
- [x] **Migrate Supabase auth, sharing, and cloud-backup wiring**
  ...
  - **Done:** [`.cursor/rules/supabase-enhancement-boundary.mdc`](../.cursor/rules/supabase-enhancement-boundary.mdc) now includes _Auth, sharing, and backup — client surfaces_ (accurate map: `locals.supabase`, `+layout.ts` / `data.supabase`, narrow `supabaseClient.ts`). **Surfaced discrepancies:** [Deferred — Supabase wiring migration notes](./readme-adr-alignment-gaps.md#supabase-wiring-migration-notes-2026-05-12) (GAP-016 / GAP-017).
