...
): Promise<['detail', Partial<Recipe> | null]> {
	const systemPrompt = `
...
-- whether items that will be combined should be prepared/cooked separately, at the same time.
Be mindful of timing when combining components. Dry ingredients should be listed before wet.
