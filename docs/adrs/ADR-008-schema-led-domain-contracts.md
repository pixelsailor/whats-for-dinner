...
The following **known gaps** exist relative to this ADR as of authoring; they are also tracked in [`docs/readme-adr-alignment-gaps.md`](../readme-adr-alignment-gaps.md):
...
| **AI JSON without `safeParse`** | Partially overlaps [GAP-006](../readme-adr-alignment-gaps.md): some Chat Completions paths parse JSON without Zod at the boundary. |

## Enforcement rules

- **Cursor / agent rules:** The backlog **Rule: Schema and type safety** in [`docs/adr-and-rules-todo.md`](../adr-and-rules-todo.md) should reference this ADR once added.
...
See **Implementation compliance (discovered)** above and GAP-007 in [`docs/readme-adr-alignment-gaps.md`](../readme-adr-alignment-gaps.md).
