...
- **Notes:** **GAP-016 resolved (2026-06-05)** — dual-key migration and browser verification complete; factory consolidation can proceed when prioritized. Overlaps items (2)–(3) in [Deferred — Supabase consolidation audit](#supabase-consolidation-audit-2026-05-10).
...
| --- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | [`src/hooks.server.ts`](../src/hooks.server.ts)                               | `createServerClient` + `PUBLIC_SUPABASE_PUBLISHABLE_KEY`                             | Yes — canonical trusted SSR auth/session path                                                        | **Yes** — **GAP-016** resolved (2026-06-05)                                                                                                                                                                                                                                                    |
...
**Maintainer position:** these env vars corresponded to **two different keys** issued by Supabase (not duplicate names for one paste). **`PUBLIC_SUPABASE_ANON_KEY` was obsolete** for forward-looking work; production source now uses **`PUBLIC_SUPABASE_PUBLISHABLE_KEY`**. **GAP-016** closed (2026-06-05) after browser verification; **GAP-017** unified client interface work remains open.
...
| **Dual public keys and multiple client factories**                             | **GAP-016** resolved (2026-06-05): dual-key split migrated to `PUBLIC_SUPABASE_PUBLISHABLE_KEY` and browser-verified. **GAP-017** tracks factory consolidation ([`.cursor/rules/supabase-enhancement-boundary.mdc`](../.cursor/rules/supabase-enhancement-boundary.mdc)).                                                                                                                                |
...
| Dual public Supabase keys and mixed client factories | **GAP-016** resolved (2026-06-05); factory consolidation remains **GAP-017**; **Supabase consolidation audit** above |
