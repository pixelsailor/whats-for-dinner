...
<div
  ...
  class={cn(
    'time-picker h-input rounded-input border-border-input bg-background text-foreground focus-within:border-border-input-hover focus-within:shadow-date-field-focus hover:border-border-input-hover data-invalid:border-destructive flex w-full max-w-[12rem] select-none items-center border px-3 py-2',
