<script lang="ts">
  ...
  let { id, label, required = false, helperText, value = $bindable(), ref = $bindable(null), ...inputProps }: InputProps = $props();
...
<div class="flex flex-col gap-1">
  ...
  {/if}
  <input id={uid} bind:this={ref} bind:value={value} class="textinput body-medium border-border-input" {...inputProps} />
  {#if helperText}
