...
- **Must stay true:** Local recipe book remains usable per ADR-001; cloud remains optional enhancement; schema-led validation remains the norm for persisted shapes (see [README](../README.md), [ADR-008](ADR-008-schema-led-domain-contracts.md), and [`.cursor/rules/schema-and-type-safety.mdc`](../.cursor/rules/schema-and-type-safety.mdc); Dexie access patterns in [`.cursor/rules/local-data-dexie-ownership.mdc`](../.cursor/rules/local-data-dexie-ownership.mdc)).
