...
<IconRoot {size}>
	{#snippet children(iconSize: number | string)}
		<svg data-svg-carbon-icon="FavoriteFilled32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" width={iconSize} height={iconSize} preserveAspectRatio="xMidYMid meet">
